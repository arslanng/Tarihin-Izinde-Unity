...
public class LevelTwoPrefabCreator : MonoBehaviour
{
    ...
    [SerializeField] private ARTrackedImageManager arTrackedImageManager2;
    ...
    {
        arTrackedImageManager2.trackedImagesChanged += OnImageChanged;

        isSetupComplete = false;
    }
    private void OnDisable()
    {
        if (arTrackedImageManager2 != null)
        {
            arTrackedImageManager2.trackedImagesChanged -= OnImageChanged;
        }
        isSetupComplete = false;
    ...
    private void OnImageChanged(ARTrackedImagesChangedEventArgs obj)
    {
        if (!isSetupComplete && target == null)
        {
            ...
            {
                if (image.referenceImage.name == "Level2TargetImage")
                {
    ...
    public void TargetDestroyer(string pageName)
    {
        ...
        {
            arTrackedImageManager2.trackedImagesChanged -= OnImageChanged;
            arTrackedImageManager2 = null;
        }
        Destroy(arTrackedImageManager2);
